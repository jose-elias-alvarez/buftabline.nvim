...
describe("set_hlgroup", function()
    ...
    describe("icon colors", function()
        ...
        it("should format icon with normal hlgroup", function()
            ...
            assert.truthy(string.find(result, "%#DevIconLuaNormal#", nil, true))
        end)
        ...
        it("should format icon with current hlgroup", function()
            ...
            assert.truthy(string.find(result, "%#DevIconLuaCurrent#", nil, true))
        end)
        ...
        it("should not format icon when icon_hl is not set", function()
            ...
            assert.falsy(string.find(result, "%#DevIconLuaCurrent#", nil, true))
        end)
        ...
        it("should format icon when tab is current and icon_colors == current", function()
        ...
        it("should not format icon when tab is current and icon_colors ~= current", function()
        ...
        it("should format icon when tab is normal and icon_colors == normal", function()
            o.set({ icon_colors = "normal" })
        ...
        it("should not format icon when tab is normal and icon_colors ~= normal", function()
            o.set({ icon_colors = "current" })
            ...
            assert.falsy(string.find(result, "%#DevIconLuaNormal#", nil, true))
        end)
    end)
end)
