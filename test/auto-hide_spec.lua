...
local open_buffers =
    function(count) for i = 1, count do vim.cmd("e" .. i) end end
...
describe("watch", function()
    ...
    it("should set showtabline to 2 when more than one buffer is open",
       function()
        open_buffers(2)
...
describe("setup", function()
    ...
    it("should not set autocmd when auto_hide and start_hidden are both true",
       function()
    ...
    it("should set autocmd when auto_hide is true and start_hidden is false",
       function()
